...
\newenvironment{activity}[1]{%
    ...
    \hfill
    \expandafter\ifstrempty\expandafter{\activity@hoursperweek}{}{\activity@hoursperweek\ \expandafter\ifstrequal\expandafter{\activity@hoursperweek}{1}{hour}{hours}/week}%
    \expandafter\ifstrempty\expandafter{\activity@hoursperweek}{}{\expandafter\ifstrempty\expandafter{\activity@weeksperyear}{}{,}}
    \expandafter\ifstrempty\expandafter{\activity@weeksperyear}{}{\activity@weeksperyear\ \expandafter\ifstrequal\expandafter{\activity@weeksperyear}{1}{week}{weeks}/year}%
    \par
    \endgroup
    \begin{itemize}[nosep]
}{%
