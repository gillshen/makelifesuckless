...
\textbf{<< test.name|to_latex >>}: << test.score|to_latex >><! if test.date !> (<< test.date.to_str(style=settings.date_style) >>)<! endif !>
<! endfor !>
<!- endif !>
...
{<! if settings.bold_award_names !>\bfseries <! endif !><< award.name|to_latex >>}, << award.date.to_str(style=settings.date_style) >>
<! endfor !>
<!- endif !>
