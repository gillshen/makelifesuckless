...
\newcommand{\headingstyle}[1]{%
    \setmainfont{<< settings.heading_font >>}[%
        LetterSpace=<! if settings.all_cap_headings !>6.0<! else !>2.0<! endif !>,
...
\newenvironment{activity}[1]{%
    ...
    \activity@weeksperyear\ \expandafter\ifstrequal\expandafter{\activity@weeksperyear}{1}{week}{weeks}/year\par
    \endgroup
    \begin{itemize}[nosep]
}{%
