...
<!- if settings.heading_font !>
    \setmainfont{<< settings.heading_font >>}[%
        LetterSpace=<< '6.0' if settings.all_cap_headings else '2.0' >>,
...
\newcommand{\edu}[2]{%
    ...
    \ifx\edu@degree\empty\else{\edu@degree\hfill}\fi%
...
\newenvironment{activity}[1]{%
    ...
    \textbf{\activity@role\ifx\activity@org\empty\else{, \activity@org}\fi}%
